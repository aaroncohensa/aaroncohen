...
public class oppDijkstraSP {
     ...
     */
    public oppDijkstraSP(com.aaron1.testschedule.controller.OppEdgeWeightedDigraph digraph, int s) {
    ...
    private boolean check(OppEdgeWeightedDigraph G, int s) {
