...
public class DijkstraSP {
    ...
    // @GetMapping()
    // public static String [] optTournArray(){
    //     com.aaron1.testschedule.controller.EdgeWeightedDigraph digraph = new com.aaron1.testschedule.controller.EdgeWeightedDigraph(TournamentController.createTournArray());
