...
public class EdgeWeightedDigraph {
     ...
     */
    public EdgeWeightedDigraph(ArrayList<com.aaron1.testschedule.model.TournamentModel> tourns) {
            ...
            for(int i = 0 ; i<tourns.size();i++){
                ...
                for(int j = i ; j<i+6 ; j++ ){
                    ...
                    if(prevWeek.weekNo == currWeek.weekNo){
                        ...
                        double weight = 100000/((3*cwMoney)+(2*cwPoints)-distance);
                        DirectedEdge dEdge = new DirectedEdge(prevWeek.tournid , currWeek.tournid , weight);
                        addEdge(dEdge);
    ...
    public static double distanceCoOrdsFormula(double lon1 , double lat1, double lon2 , double lat2){
